...
namespace CheckComboBox
{
    ...
    public class CheckComboBoxItem
    {
        ...
        public CheckComboBoxItem( string text, bool initialCheckState, CheckComboBox parent )
        {
            _checkState = initialCheckState;
            _text = text;
            _parent = parent;
        }
        private CheckComboBox _parent;
        ...
        {
            return _parent.SelectedItemsText;
    ...
    public partial class CheckComboBox : ComboBox
    {
        ...
        public CheckComboBox()
        {
            ...
            this.DropDownClosed += CheckComboBox_DropDownClosed;
            this.CheckStateChanged += CheckComboBox_CheckStateChanged;
            SelectedText = "Select Options";
        }

        void CheckComboBox_CheckStateChanged(object sender, EventArgs e)
        {
            DroppedDown = true;
        }
