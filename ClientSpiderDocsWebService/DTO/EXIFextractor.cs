    ...
    namespace EXIF
    {
        ...
        public class EXIFextractor : IEnumerable
        {
            ...
            public void setTag(int id, int len, short type, byte[] data)
            {
                ...
                this.img.SetPropertyItem(p);
                buildDB(this.img.PropertyItems);
            }
            /// <summary>
            /// 
            /// </summary>
            ...
            private static PropertyItem CreatePropertyItem(short type, int tag, int len, byte[] value)
            {
                ...
                Stream emptyBitmapStream = assembly.GetManifestResourceStream(HttpContext.Current.Server.MapPath("~/decoy.jpg"));
            ...
            /// <param name="sp"></param>
            public EXIFextractor(ref System.Drawing.Image img, string sp)
            {
            ...
            string msp = "";
            public EXIFextractor(ref System.Drawing.Image img, string sp, string msp)
            {
                properties = new Hashtable();
                this.sp = sp;
                this.msp = msp;
                ...
                //				
                myHash = new translation();
                this.buildDB(img.PropertyItems);
