...
public static partial class ConfigurationFactory
{
    ...
    public class SpiderDocsConf : WebSpiderDocs.Helpers.SpiderDocHelper.IConfiguration
    {
        ...
        */
        public string GetWebTempPath()
        {
            ...
            WebSpiderDocs.Helpers.Fn.MkDir(path);
            return path;
        }

        public string GetWebTempURL()
        {
            string webHome = WebSpiderDocs.Helpers.Fn.ToWebPath(GetWebTempPath().Replace(System.Web.HttpRuntime.AppDomainAppPath, ""))
    ...
    public class SpiderWebClientConf : WebSpiderDocs.Helpers.SpiderDoscWebClient.IConfiguration
    {
        Logger logger;
